...
-- ==========================================
-- Core tables: profiles, matches, messages, feedback
-- Verification tables moved to migration 007
-- ==========================================
...
CREATE TABLE public.profiles (
    ...
    -- Embeddings for AI matching (upgraded to 1024D in migration 002)
    profile_embedding vector(768),  -- ko-sroberta embedding (temporary, upgraded in 002)

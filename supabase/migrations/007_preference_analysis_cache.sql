-- ==========================================
-- Preference Analysis Cache
-- Cache AI analysis results for common preferences to reduce costs and improve performance
-- ==========================================
...
-- Function to increment usage count when cache is accessed
...
-- Function to clean old cache entries (keep only top 1000 most used)

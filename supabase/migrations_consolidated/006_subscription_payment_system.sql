...
-- ==========================================
-- PART 1: SUBSCRIPTION COLUMNS IN PROFILES
-- ==========================================
-- Note: paid_tier, subscription_status, and related columns already defined in 001_core_schema.sql
-- Subscription status values: none, active, expired, cancelled, trial
